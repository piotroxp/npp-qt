...
// Qt6 port: Win32 User-Define dialog resource IDs → Qt namespace constants
// These IDs are used for the User Defined Language (UDL) configuration dialog.
