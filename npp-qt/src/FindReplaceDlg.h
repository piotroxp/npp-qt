...
#include <QThread>
#include "WinControls/FindResultPanel/FindResultPanel.h"
...
private:
    ...
    QTextBrowser* _fifResultsEdit = nullptr;  // deprecated — results go to _findResultPanel
    FindResultPanel* _findResultPanel = nullptr;
