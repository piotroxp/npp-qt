#ifndef MENU_CMD_ID_H
#define MENU_CMD_ID_H

// NOTE: Do NOT add #pragma once here. npp_pch.h undefs this guard and re-includes
// this file after NppSciCompat.h (which undefs IDM_* to avoid macro/constexpr conflicts).
// #pragma once would prevent that re-inclusion and break the IDM_* macros in TUs.
...
#define    IDM_FILE_RESTORELASTCLOSED                (IDM_FILE + 22)
#define    IDM_FILE_OPENFOLDERASWORKSPACE            (IDM_FILE + 23)
#define    IDM_FILE_OPEN_DEFAULT_VIEWER              (IDM_FILE + 24)
#define    IDM_FILE_SAVE_READONLY                   (IDM_FILE + 25)
#define    IDM_FILE_READONLY                        (IDM_FILE + 26)
#define    IDM_FILE_CLEAR_READONLY                  (IDM_FILE + 27)
#define    IDM_FILE_MONITOR                         (IDM_FILE + 28)
#define    IDM_FILE_CLOSEALL_UNCHANGED               (IDM_FILE + 29)
...
//11  Close
//12  Close All
//13  Close All But Current
//14  Close All to the Left
//15  Close All to the Right
//16  Print
//17  Exit
//18  Load Session
//19  Save Session
...
//22  Delete
//23  Rename
//24  Close All to Right
//25  Open Folder
//26  Open in Command Prompt
//27  Restore Last Closed File
//28  Restore Last Closed
//29  Open Folder as Workspace
//30  Open in Default Viewer
//31  Save Read-Only
//32  Read-Only
//33  Clear Read-Only Flag
//34  Monitor (Tail)
...
#define    IDM_EDIT_CONSECUTIVE_DUP_LINES_REMOVE            (IDM_EDIT + 107)
#define    IDM_EDIT_ANY_DUP_LINES_REMOVE                    (IDM_EDIT + 108)
#define    IDM_EDIT_TRIM_LEADING                            (IDM_EDIT + 109)
#define    IDM_EDIT_TRIM_TRAILING                           (IDM_EDIT + 110)
#define    IDM_EDIT_EOL_TO_WS                               (IDM_EDIT + 111)
#define    IDM_EDIT_TRIM_ALL                                (IDM_EDIT + 112)
#define    IDM_EDIT_TAB_TO_SPACE                            (IDM_EDIT + 113)
#define    IDM_EDIT_SPACE_TO_TAB_ALL                        (IDM_EDIT + 114)
#define    IDM_EDIT_SPACE_TO_TAB_LEADING                    (IDM_EDIT + 115)
#define    IDM_EDIT_READONLY                               (IDM_EDIT + 116)
...
#define    IDM_EDIT_FUNCCALLTIP_PREV                        (50000 + 12)
...
#define    IDM_SEARCH_FINDINPROJECTS      (IDM_SEARCH + 70)
#define    IDM_SEARCH_FINDINFILEN         (IDM_SEARCH + 71)
#define    IDM_SEARCH_CUTBOOKMARK         (IDM_SEARCH + 72)
#define    IDM_SEARCH_COPYBOOKMARK        (IDM_SEARCH + 73)
#define    IDM_SEARCH_PASTEBOOKMARK       (IDM_SEARCH + 74)
#define    IDM_SEARCH_DELETEBOOKMARK      (IDM_SEARCH + 75)
...
#define    IDM_VIEW_DRAWTABBAR_TOPBAR        (IDM_VIEW + 7)
#define    IDM_VIEW_DRAWTABBAR_INACTIVETAB   (IDM_VIEW + 8)
#define    IDM_VIEW_FOLDSYMBOLSIMPLE         (IDM_VIEW + 12)
#define    IDM_VIEW_FOLDSYMBOLARROW          (IDM_VIEW + 13)
#define    IDM_VIEW_FOLDSYMBOLCIRCLE        (IDM_VIEW + 14)
#define    IDM_VIEW_FOLDSYMBOLBOX           (IDM_VIEW + 15)
#define    IDM_VIEW_FOLDSYMBOLNONE          (IDM_VIEW + 16)
...
#define    IDM_LANGUAGE    (IDM_LANG)  // alias for shortcut.cpp
#define    IDM_LANGSTYLE_CONFIG_DLG    (IDM_LANG + 1)
#define    IDM_LANG_START             (IDM_LANG + 1)  // sentinel: first language submenu item
#define    IDM_LANG_C                  (IDM_LANG + 2)
#define    IDM_LANG_CPP                (IDM_LANG + 3)
#define    IDM_LANG_JAVA               (IDM_LANG + 4)
#define    IDM_LANG_HTML               (IDM_LANG + 5)
#define    IDM_LANG_HTML_MULTI         (IDM_LANG + 5)  // alias: HTML-multi is same base as HTML
...
#define    IDM_LANG_JSON_PATH         (IDM_LANG + 57)  // alias: JSON-path is same base as JSON
...
#define    IDM_HELP_DOC         (IDM_HELP + 2)
#define    IDM_HELP_HOME       (IDM_HELP + 3)
#define    IDM_HELP_ONLINE     (IDM_HELP + 4)
...
#define    IDM_TOOLS       (IDM_TOOL)  // alias for shortcut.cpp
...
#define    IDM_RUN  (IDM + 9000)
#define    IDM_RUN_LOOKUPDLG              (IDM_RUN + 1)
#define    IDM_RUN_MODIFYLOOKUPDLG        (IDM_RUN + 2)
#define    IDM_RUN_CLEANUPLOOKUPDLG       (IDM_RUN + 3)
#define    IDM_RUN_RUNCURRENTFILE        (IDM_RUN + 4)

// Aliases used by Qt translation (shortcut.cpp) for menu category mapping
#define    IDM_WINDOW    (IDR_WINDOWS_MENU)  // top-level Window menu ID
...
#define  IDM_WINDOW_SORT_ASC     (IDR_WINDOWS_MENU + 12)
#define  IDM_WINDOW_SORT_DESC    (IDR_WINDOWS_MENU + 13)
