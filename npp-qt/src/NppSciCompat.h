...
// Using a traditional include guard instead of #pragma once so that the #undef
// directives below execute on EVERY inclusion (including re-inclusion from
// shortcut.h which directly #includes this header after the PCH has done so).
#ifndef NPP_SCICOMPAT_H
#define NPP_SCICOMPAT_H
...
namespace npp_sci {
    ...
    constexpr int SCE_UNIVERSAL_FOUND_STYLE_INC   = 34;
    constexpr int SCE_UNIVERSAL_TAGATTR            = 26;
    constexpr int SCE_UNIVERSAL_TAGMATCH           = 27;
...
using npp_sci::SCI_SETELEMENTCOLOUR;
using npp_sci::SCI_SETPRINTCOLOURMODE;
using npp_sci::SCI_FORMATRANGEFULL;
