...
// Undef all Scintilla.h macros that are used as npp_sci::SC_* below.
// When this file is compiled via moc_NppNotification.cpp: the PCH's
// NppSciCompat.h uses #pragma once (skips re-include, no #undef SC_* run).
// Then NppNotification.h includes Scintilla.h which defines SC_* macros.
// This file's npp_sci::SC_* references would otherwise be macro-expanded.
// Self-contained #undef here fixes this regardless of include order.
#undef SC_PRINT_COLOURONWHITE
#undef SC_PRINT_BLACKONWHITE
#undef SC_PRINT_INVERTLIGHT
#undef SC_PRINT_COLOURONWHITEDEFAULTBG
#undef SC_PRINT_SCREENCOLOURS
#undef SC_MOD_NONE
...
#undef SC_PERFORMED_USER
#undef SC_PERFORMED_UNDO
#undef SC_PERFORMED_REDO
#undef SC_MULTISTEPUNDOREDO
#undef SC_LASTSTEPINUNDOREDO
#undef SC_MOD_CHANGEMARKER
#undef SC_CASE_LOWER
#undef SC_CASE_CAMEL
#undef SCI_STYLEGETFORE
#undef SCI_STYLEGETBACK
#undef SCI_STYLEGETBOLD
#undef SCI_STYLEGETITALIC
#undef SCI_STYLEGETSIZE
#undef SCI_STYLEGETFONT
#undef ARCH_TYPE
#undef CARETSTYLE_LINE_1
#undef IMAGE_FILE_MACHINE_AMD64
#undef IMAGE_FILE_MACHINE_ARM64
#undef IMAGE_FILE_MACHINE_I386
#undef INDIC_EXPLORERLINK
#undef INDIC_FULLBOX
#undef INDIC_HIDDEN
#undef INDIC_HYPERLINK
#undef INDIC_PLAIN
#undef INDIC_SPELL
#undef SCEN_CHANGE
#undef SCEN_KILLFOCUS
#undef SCEN_SETFOCUS
#undef SCE_UNIVERSAL_FOUND_STYLE
#undef SCE_UNIVERSAL_FOUND_STYLE_EXT1
#undef SCE_UNIVERSAL_FOUND_STYLE_EXT2
#undef SCE_UNIVERSAL_FOUND_STYLE_EXT3
#undef SCE_UNIVERSAL_FOUND_STYLE_EXT4
#undef SCE_UNIVERSAL_FOUND_STYLE_EXT5
#undef SCE_UNIVERSAL_FOUND_STYLE_SMART
#undef SCE_USER_KWLIST_COMMENTS
#undef SCE_USER_KWLIST_DELIMITERS
#undef SCE_USER_KWLIST_KEYWORDS1
#undef SCE_USER_KWLIST_KEYWORDS2
#undef SCE_USER_KWLIST_KEYWORDS3
#undef SCE_USER_KWLIST_KEYWORDS4
#undef SCE_USER_KWLIST_KEYWORDS5
#undef SCE_USER_KWLIST_KEYWORDS6
#undef SCE_USER_KWLIST_KEYWORDS7
#undef SCE_USER_KWLIST_KEYWORDS8
#undef SCE_USER_KWLIST_KEYWORDS9
#undef SCE_USER_KWLIST_TOTAL
#undef SCE_USER_TOTAL_KEYWORD_GROUPS
#undef SCFIND_MATCHCASE
#undef SCFIND_POSIX
#undef SCFIND_REGEXP
#undef SCFIND_REGEXP_DOTMATCHESNL
#undef SCFIND_WHOLEWORD
#undef SCFIND_WORDSTART
#undef SCI_ADDREFDOCUMENT
#undef SCI_ANNOTATIONGETMOUSENOTIFICATION
#undef SCI_ANNOTATIONSETMOUSENOTIFICATION
#undef SCI_APPENDTEXT
#undef SCI_AUTOCCANCEL
#undef SCI_AUTOCGETSEPARATOR
#undef SCI_AUTOCSETAUTOHIDE
#undef SCI_AUTOCSETDROPRESTOFWORD
#undef SCI_AUTOCSETIGNORECASE
#undef SCI_AUTOCSETMULTI
#undef SCI_AUTOCSETSEPARATOR
#undef SCI_AUTOCSHOW
#undef SCI_BACKTAB
#undef SCI_BEGINUNDOACTION
#undef SCI_BRACEBADLIGHT
#undef SCI_BRACEHIGHLIGHT
#undef SCI_BRACEMATCH
#undef SCI_CALLTIPACTIVE
#undef SCI_CALLTIPCANCEL
#undef SCI_CALLTIPSHOW
#undef SCI_CANCEL
#undef SCI_CANPASTE
#undef SCI_CANREDO
#undef SCI_CANUNDO
#undef SCI_CHARLEFT
#undef SCI_CHARLEFTEXTEND
#undef SCI_CHARLEFTRECTEXTEND
#undef SCI_CHARRIGHT
#undef SCI_CHARRIGHTEXTEND
#undef SCI_CHARRIGHTRECTEXTEND
#undef SCI_CHOOSECARETX
#undef SCI_CLEAR
#undef SCI_CLEARALL
#undef SCI_COLOURISE
#undef SCI_COPY
#undef SCI_COUNTCHARACTERS
#undef SCI_CREATEDOCUMENT
#undef SCI_CUT
#undef SCI_DELETEBACK
#undef SCI_DELETEBACKNOTLINE
#undef SCI_DELETELINE
#undef SCI_DELETERANGE
#undef SCI_DELLINELEFT
#undef SCI_DELLINERIGHT
#undef SCI_DELWORDLEFT
#undef SCI_DELWORDRIGHT
#undef SCI_DELWORDRIGHTEND
#undef SCI_DOCLINEFROMVISIBLE
#undef SCI_DOCUMENTEND
#undef SCI_DOCUMENTENDEXTEND
#undef SCI_DOCUMENTSTART
#undef SCI_DOCUMENTSTARTEXTEND
#undef SCI_EDITTOGGLEOVERTYPE
#undef SCI_EMPTYUNDOBUFFER
#undef SCI_ENDUNDOACTION
#undef SCI_ENSUREVISIBLE
#undef SCI_ENSUREVISIBLEENFORCEPOLICY
#undef SCI_FINDCOLUMN
#undef SCI_FOLDDISPLAYTEXTSTYLE
#undef SCI_FORMATRANGEFULL
#undef SCI_FORMFEED
#undef SCI_GETANCHOR
#undef SCI_GETCHANGEHISTORY
#undef SCI_GETCHARACTERPOINTER
#undef SCI_GETCHARAT
#undef SCI_GETCODEPAGE
#undef SCI_GETCOLUMN
#undef SCI_GETCURRENTLINE
#undef SCI_GETCURRENTPOS
#undef SCI_GETDOCPOINTER
#undef SCI_GETEOLMODE
#undef SCI_GETFIRSTVISIBLELINE
#undef SCI_GETFOLDEXPANDED
#undef SCI_GETFOLDLEVEL
#undef SCI_GETINDENTATIONGUIDES
#undef SCI_GETLASTVISIBLELINE
#undef SCI_GETLENGTH
#undef SCI_GETLINE
#undef SCI_GETLINECOUNT
#undef SCI_GETLINEENDPOSITION
#undef SCI_GETLINEINDENTPOSITION
#undef SCI_GETLINESELENDPOSITION
#undef SCI_GETLINESELSTARTPOSITION
#undef SCI_GETMARGINWIDTHN
#undef SCI_GETMOUSESELECTIONRECTANGULARPROBABILITYTHRESHOLD
#undef SCI_GETOVERTYPE
#undef SCI_GETPOSITIONCACHESIZE
#undef SCI_GETREADONLY
#undef SCI_GETSELBACK
#undef SCI_GETSELECTIONEMPTY
#undef SCI_GETSELECTIONEND
#undef SCI_GETSELECTIONLAYER
#undef SCI_GETSELECTIONMODE
#undef SCI_GETSELECTIONNEND
#undef SCI_GETSELECTIONNSTART
#undef SCI_GETSELECTIONS
#undef SCI_GETSELECTIONSTART
#undef SCI_GETSELTEXT
#undef SCI_GETSTYLEAT
#undef SCI_GETSTYLEINDEXAT
#undef SCI_GETTABWIDTH
#undef SCI_GETTARGETEND
#undef SCI_GETTARGETSTART
#undef SCI_GETTARGETTEXT
#undef SCI_GETTEXTDIRECTION
#undef SCI_GETTEXTLENGTH
#undef SCI_GETTEXTRANGE
#undef SCI_GETWRAPINDENTMODE
#undef SCI_GETXOFFSET
#undef SCI_GETZOOM
#undef SCI_GOTOLINE
#undef SCI_GOTOPOS
#undef SCI_HOME
#undef SCI_HOMEDISPLAY
#undef SCI_HOMEDISPLAYEXTEND
#undef SCI_HOMEEXTEND
#undef SCI_HOMERECTEXTEND
#undef SCI_HOMEWRAP
#undef SCI_HOMEWRAPEXTEND
#undef SCI_INDICATORCLEARRANGE
#undef SCI_INDICATOREND
#undef SCI_INDICATORFILLRANGE
#undef SCI_INDICATORSTART
#undef SCI_INDICATORVALUEAT
#undef SCI_INDICGETHOVERSTYLE
#undef SCI_INDICGETSTYLE
#undef SCI_INDICSETALPHA
#undef SCI_INDICSETFLAGS
#undef SCI_INDICSETHOVERSTYLE
#undef SCI_INDICSETSTYLE
#undef SCI_INSERTLINE
#undef SCI_INSERTTEXT
#undef SCI_LINECOPY
#undef SCI_LINECUT
#undef SCI_LINEDELETE
#undef SCI_LINEDOWN
#undef SCI_LINEDOWNEXTEND
#undef SCI_LINEDOWNRECTEXTEND
#undef SCI_LINEDUPLICATE
#undef SCI_LINEEND
#undef SCI_LINEENDDISPLAY
#undef SCI_LINEENDDISPLAYEXTEND
#undef SCI_LINEENDEXTEND
#undef SCI_LINEENDRECTEXTEND
#undef SCI_LINEENDWRAP
#undef SCI_LINEENDWRAPEXTEND
#undef SCI_LINEFROMPOSITION
#undef SCI_LINELENGTH
#undef SCI_LINESCROLL
#undef SCI_LINESCROLLDOWN
#undef SCI_LINESCROLLUP
#undef SCI_LINESJOIN
#undef SCI_LINESONSCREEN
#undef SCI_LINETRANSPOSE
#undef SCI_LINEUP
#undef SCI_LINEUPEXTEND
#undef SCI_LINEUPRECTEXTEND
#undef SCI_MARGINTEXTGETTEXT
#undef SCI_MARKERADD
#undef SCI_MARKERDELETE
#undef SCI_MARKERDELETEALL
#undef SCI_MARKERGET
#undef SCI_MARKERNEXT
#undef SCI_MARKERPREVIOUS
#undef SCI_MOVECARETINSIDEVIEW
#undef SCI_NEWLINE
#undef SCI_PAGEDOWN
#undef SCI_PAGEDOWNEXTEND
#undef SCI_PAGEDOWNRECTEXTEND
#undef SCI_PAGEUP
#undef SCI_PAGEUPEXTEND
#undef SCI_PAGEUPRECTEXTEND
#undef SCI_PARADOWN
#undef SCI_PARADOWNEXTEND
#undef SCI_PARAUP
#undef SCI_PARAUPEXTEND
#undef SCI_PASTE
#undef SCI_POINTXFROMPOSITION
#undef SCI_POINTYFROMPOSITION
#undef SCI_POSITIONAFTER
#undef SCI_POSITIONBEFORE
#undef SCI_POSITIONFROMLINE
#undef SCI_POSITIONFROMPOINT
#undef SCI_REDO
#undef SCI_RELEASEDOCUMENT
#undef SCI_REPLACESEL
#undef SCI_REPLACETARGET
#undef SCI_ROTATESELECTION
#undef SCI_SCROLLCARET
#undef SCI_SEARCHINTARGET
#undef SCI_SELECTALL
#undef SCI_SELECTIONCONTAINS
#undef SCI_SELECTIONDUPLICATE
#undef SCI_SELECTIONISRECTANGLE
#undef SCI_SETADDITIONALSELECTIONTYPING
#undef SCI_SETANCHOR
#undef SCI_SETAUTOMATICFOLD
#undef SCI_SETBRACKETLIGHTLINE
#undef SCI_SETCARETLINEVISIBLEALWAYS
#undef SCI_SETCHANGEHISTORY
#undef SCI_SETCODEPAGE
#undef SCI_SETCURRENTPOS
#undef SCI_SETDOCPOINTER
#undef SCI_SETELEMENTCOLOUR
#undef SCI_SETENDATLASTLINE
#undef SCI_SETFONTQUALITY
#undef SCI_SETHIGHLIGHTGUIDE
#undef SCI_SETILEXER
#undef SCI_SETINDICATORCURRENT
#undef SCI_SETINDICATORVALUE
#undef SCI_SETLAZYEND
#undef SCI_SETMARGINLEFT
#undef SCI_SETMARGINRIGHT
#undef SCI_SETMARGINWIDTHN
#undef SCI_SETMODEVENTMASK
#undef SCI_SETMOUSESELECTIONRECTANGULARPROBABILITYTHRESHOLD
#undef SCI_SETMOUSESELECTIONRECTANGULARSWITCH
#undef SCI_SETMULTIPASTE
#undef SCI_SETPRINTCOLOURMODE
#undef SCI_SETREADONLY
#undef SCI_SETSAVEPOINT
#undef SCI_SETSEARCHFLAGS
#undef SCI_SETSEL
#undef SCI_SETSELECTION
#undef SCI_SETSELECTIONEND
#undef SCI_SETSELECTIONLAYER
#undef SCI_SETSELECTIONSTART
#undef SCI_SETSTATUS
#undef SCI_SETTARGETEND
#undef SCI_SETTARGETRANGE
#undef SCI_SETTARGETSTART
#undef SCI_SETUNDOCOLLECTION
#undef SCI_SETUNDOSELECTIONHISTORY
#undef SCI_SETVIRTUALSPACEOPTIONS
#undef SCI_SETWRAPINDENTMODE
#undef SCI_SETZOOM
#undef SCI_STUTTEREDPAGEDOWN
#undef SCI_STUTTEREDPAGEDOWNEXTEND
#undef SCI_STUTTEREDPAGEUP
#undef SCI_STUTTEREDPAGEUPEXTEND
#undef SCI_STYLEGETBACK
#undef SCI_STYLEGETFORE
#undef SCI_STYLESETCHECKMONOSPACED
#undef SCI_SWAPMAINANCHORCARET
#undef SCI_TAB
#undef SCI_TARGETFROMSELECTION
#undef SCI_TARGETWHOLEDOCUMENT
#undef SCI_TEXTHEIGHT
#undef SCI_TEXTWIDTH
#undef SCI_UNDO
#undef SCI_USEPOPUP
#undef SCI_VCHOME
#undef SCI_VCHOMEDISPLAY
#undef SCI_VCHOMEDISPLAYEXTEND
#undef SCI_VCHOMEEXTEND
#undef SCI_VCHOMERECTEXTEND
#undef SCI_VCHOMEWRAP
#undef SCI_VCHOMEWRAPEXTEND
#undef SCI_WORDENDPOSITION
#undef SCI_WORDLEFT
#undef SCI_WORDLEFTEND
#undef SCI_WORDLEFTENDEXTEND
#undef SCI_WORDLEFTEXTEND
#undef SCI_WORDPARTLEFT
#undef SCI_WORDPARTLEFTEXTEND
#undef SCI_WORDPARTRIGHT
#undef SCI_WORDPARTRIGHTEXTEND
#undef SCI_WORDRIGHT
#undef SCI_WORDRIGHTEND
#undef SCI_WORDRIGHTENDEXTEND
#undef SCI_WORDRIGHTEXTEND
#undef SCI_WORDSTARTPOSITION
#undef SCI_ZOOMIN
#undef SCI_ZOOMOUT
#undef SCK_ADD
#undef SCK_BACK
...
#undef SCK_UP
#undef SCLEX_INNO
#undef SCLEX_OBJECTIVEC
#undef SCVS_NOWRAPLINESTART
#undef SCVS_RECTANGULARSELECTION
#undef SCVS_USERACCESSIBLE
#undef SC_AUTOMATICFOLD_CHANGE
#undef SC_AUTOMATICFOLD_SHOW
#undef SC_CHANGE_HISTORY_DISABLED
#undef SC_EFF_QUALITY_LCD_OPTIMIZED
#undef SC_EOL_CR
#undef SC_EOL_CRLF
#undef SC_EOL_LF
#undef SC_FOLDLEVELBASE
#undef SC_FOLDLEVELHEADERFLAG
#undef SC_FOLDLEVELNUMBERMASK
#undef SC_INDICFLAG_VALUEFORE
#undef SC_MARKNUM_HISTORY_MODIFIED
#undef SC_MARKNUM_HISTORY_REVERTED_TO_MODIFIED
#undef SC_MARKNUM_HISTORY_REVERTED_TO_ORIGIN
#undef SC_MARKNUM_HISTORY_SAVED
#undef SC_MARK_DOT
...
#undef SC_MULTIAUTOC_EACH
#undef SC_MULTIPASTE_EACH
#undef SC_PERFORMED_REDO
#undef SC_PERFORMED_UNDO
#undef SC_POPUP_NEVER
#undef SC_PRINT_BLACKONBLUE
#undef SC_PRINT_BLACKONWHITE
#undef SC_PRINT_COLOURONWHITE
#undef SC_PRINT_COLOURONWHITEDEFAULTBG
#undef SC_PRINT_NORMAL
#undef SC_PRINT_REVERSE_COLOUR
#undef SC_PRINT_SCREENCOLOURS
#undef SC_SEARCHRESULTPOS
#undef SC_SEL_LINES
#undef SC_SEL_RECTANGLE
#undef SC_SEL_STREAM
#undef SC_SEL_THIN
#undef SC_UNDO_SELECTION_HISTORY_ENABLED
#undef SC_UNDO_SELECTION_HISTORY_SCROLL
#undef SC_UPDATE_CONTENT
#undef SC_UPDATE_H_SCROLL
#undef SC_UPDATE_NONE
#undef SC_UPDATE_SELECTION
#undef SC_UPDATE_V_SCROLL
#undef STATUSBAR_CUR_POS
#undef STATUSBAR_DOC_SIZE
#undef STATUSBAR_DOC_TYPE
#undef STATUSBAR_EOF_FORMAT
#undef STATUSBAR_TYPING_MODE
#undef STATUSBAR_UNICODE_TYPE
#undef STYLE_DEFAULT
#undef TABBAR_ACTIVEFOCUSEDINDCATOR
#undef TABBAR_ACTIVETEXT
#undef TABBAR_ACTIVEUNFOCUSEDINDCATOR
#undef TABBAR_INACTIVETEXT
#undef URL_INDIC
#undef VIEWZONE_DOCUMENTMAP
#undef SCI_STYLEGETEOLFILLED
#undef SCI_STYLEGETUNDERLINE
#undef SC_ELEMENT_HOT_SPOT_ACTIVE
#undef SC_ELEMENT_HOT_SPOT_ACTIVE_BACK
#undef SC_ELEMENT_FOLD_LINE
#undef SC_ELEMENT_HIDDEN_LINE
#undef SC_GETELEMENTCOLOUR
#undef SC_RESETELEMENTCOLOUR
#undef SC_GETELEMENTISSET
#undef SC_GETELEMENTALLOWSTRANSLUCENT
#undef SC_GETELEMENTCOLOURTRANSLUCENT
#undef SC_SETELEMENTCOLOUR
#undef SC_RESETELEMENTCOLOURS
...
// menuCmdID.h is included LATE (after shortcut.h/keys.h) to avoid macro vs const
// name collisions: keys.h defines const int IDM_* = N; if menuCmdID.h's #define
// IDM_* are visible, const int IDM_* declarations become syntax errors.
...
// NppSciCompat.h is included via shortcut.h (below) → ScintillaComponent.h.
// Do NOT include it directly here — that would be a double-include where the
// pragma once blocks the second inclusion's SC_UPDATE_* undefs.
...
// shortcut.h (included below) handles menuCmdID.h inclusion in the correct
// order: #include "menuCmdID.h" BEFORE #include "keys.h" with #undef IDM_*
// after keys.h so C++ sees const int IDM_* values.
...
// Scintilla headers are included above (before Common.h/shortcut.h) via NppSciCompat.h.

static const QString kDefaultShell = QStringLiteral("/bin/sh");


// ─── Undef Scintilla macros BEFORE class bodies ───
// Common.h → shortcut.h → Scintilla.h re-introduced 827 #define SCI_* macros.
// These macros corrupt npp_sci::SCI_* identifiers in class body default initializers
// (the preprocessor expands npp_sci::SC_PRINT_COLOURONWHITE to npp_sci::3).
// Undef all of them so the C++ parser sees npp_sci::SCI_* as qualified identifiers.

// These Scintilla #defines clash with npp_sci:: namespace constants used as array sizes.
#undef SCE_USER_KWLIST_TOTAL
#undef SCE_USER_TOTAL_KEYWORD_GROUPS
...
class NppMatchedPairConf final
{
public:
...
struct NppGUI final
{
    ...
    NppMatchedPairConf _matchedPairConf;
...
public:
    std::string _name;
    void* fnCL = nullptr; // Lexilla::CreateLexerFn — resolved by PluginsManager::loadLexillaLexersFromPlugin()
    // For Notepad++
...
public:
    ...
    // Autocomplete status (0=disabled, 1=word, 2=func, 3=both)
    int getAutoCompletionStatus() const { return static_cast<int>(_nppGUI._autocStatus); }
    int getAutoCompletionFromLen() const { return _nppGUI._autocFromLen; }
    ...
    void writeSettingsFilesOnTheCloudForThe1stTime(const wchar_t* settingsPath = nullptr) const;
