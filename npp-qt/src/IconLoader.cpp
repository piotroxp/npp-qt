...
// ICONLOADER_HAVE_SVG is set by CMake's target_compile_definitions based on
// whether Qt6::Svg TARGET actually exists (not Qt's QT_SVG_LIB, which AUTOMOC
// defines in moc_predefs.h even when Qt6Svg is absent).
#if ICONLOADER_HAVE_SVG
