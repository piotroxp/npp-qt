...
void MainWindow::setupUi()
{
    ...
    connect(static_cast<QTabWidget*>(_pTabBar), &QTabWidget::currentChanged, this, qOverload<int>(&MainWindow::onTabChanged));
    connect(static_cast<QTabWidget*>(_pTabBar), &QTabWidget::tabCloseRequested, this, &MainWindow::onTabCloseRequested);
}
...
void MainWindow::createMenus()
{
    ...
    fileMenu->addAction(tr("&New"), this, [this]() { newFile(); }, QKeySequence::New);
    fileMenu->addAction(tr("&Open..."), this, [this]() { openFile(); }, QKeySequence::Open);
    fileMenu->addSeparator();
    fileMenu->addAction(tr("&Save"), this, [this]() { saveFile(); }, QKeySequence::Save);
    fileMenu->addAction(tr("Save &As..."), this, [this]() { saveFileAs(); }, QKeySequence::SaveAs);
    fileMenu->addSeparator();
    fileMenu->addAction(tr("&Close"), this, [this]() { closeFile(); }, QKeySequence::Close);
    fileMenu->addSeparator();
    fileMenu->addAction(tr("E&xit"), this, [this]() { exit(); }, QKeySequence::Quit);
...
void MainWindow::createToolBars()
{
    ...
    _pFileToolBar->addAction(tr("New"), this, [this]() { newFile(); });
    _pFileToolBar->addAction(tr("Open"), this, [this]() { openFile(); });
    _pFileToolBar->addAction(tr("Save"), this, [this]() { saveFile(); });
