...
// ── npp_sci namespace + Scintilla compatibility ─────────────────────────────
// npp_pch.h already includes Qsci headers (qsciscintillabase.h, qsciscintilla.h,
// qsciprinter.h) in the correct order and NppSciCompat.h after them. Due to
// include guards, these are no-ops here — but we still include them so the file
// is self-contained if used outside the normal build system.
