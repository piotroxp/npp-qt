...
size_t Printer::doPrintImpl(QPrinter& printer)
{
	...
	QString shortDate = QLocale::system().toString(now.date(), QLocale::ShortFormat);
	QString longDate = QLocale::system().toString(now.date(), QLocale::LongFormat);
	QString time = QLocale::system().toString(now.time(), QLocale::ShortFormat);
