...
#include "../../../npp-qt/src/WinControls/StatusBar.h"
...
void StatusBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (StatusBar::*)(int )>(_a, &StatusBar::statusClicked, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (StatusBar::*)(int )>(_a, &StatusBar::statusDoubleClicked, 1))
            return;
    }
}
