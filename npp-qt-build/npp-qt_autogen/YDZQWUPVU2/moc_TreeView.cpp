...
#include "../../../npp-qt/src/WinControls/TreeView.h"
...
template <> constexpr inline auto TreeView::qt_create_metaobjectdata<qt_meta_tag_ZN8TreeViewE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'itemRenamed'
        QtMocHelpers::SignalData<void(QTreeWidgetItem *, const QString &)>(6, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 }, { QMetaType::QString, 7 },
        }}),
        // Signal 'itemDragged'
        QtMocHelpers::SignalData<void(QTreeWidgetItem *)>(8, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Signal 'itemDropped'
        QtMocHelpers::SignalData<void(QTreeWidgetItem *, QTreeWidgetItem *)>(9, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void TreeView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TreeView::*)(QTreeWidgetItem * )>(_a, &TreeView::itemExpanded, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (TreeView::*)(QTreeWidgetItem * )>(_a, &TreeView::itemCollapsed, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (TreeView::*)(QTreeWidgetItem * , const QString & )>(_a, &TreeView::itemRenamed, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (TreeView::*)(QTreeWidgetItem * )>(_a, &TreeView::itemDragged, 3))
            return;
        if (QtMocHelpers::indexOfMethod<void (TreeView::*)(QTreeWidgetItem * , QTreeWidgetItem * )>(_a, &TreeView::itemDropped, 4))
            return;
    }
}
