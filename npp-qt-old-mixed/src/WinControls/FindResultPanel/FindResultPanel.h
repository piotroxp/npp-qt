...
// =============================================================================
class FindResultPanel : public DockingWnd
{
    Q_OBJECT
...
public:
    ...
    void display(bool doShow) override;
    const wchar_t* getDocFileName() override { return L"Find Result"; }
    void setBackgroundColor(const QColor&) override {}
    void setForegroundColor(const QColor&) override {}
    void setScintillaFont(const QString&) override {}
