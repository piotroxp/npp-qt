...
public:
    ...
    double ratio() const; // returns 0.0-1.0, uses splitter sizes if available

    // Orientation
    bool isVertical() const { return _splitter->orientation() == Qt::Vertical; }

    // Visibility
    void show(); // QWidget::show() reimplemented for dark mode
    void hide(); // QWidget::hide() reimplemented for dark mode
