...
// Qt6 port: Word Style dialog resource IDs → Qt object names / property keys

#pragma once

// Styler dialog (per-language style configuration)
#define IDD_STYLER_DLG  2200
    ...
    // Global override checkboxes (foreground / background / font)
    ...
    // Note: 2210 was used historically for IDC_STYLEDEFAULT_WARNING_STATIC
    // but is no longer used, to maintain compatibility with translation XML files.

// Global Styler dialog (global style overrides)
