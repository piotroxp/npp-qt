...
public:
    ...
    NppXmlDoc* getNativeLang() const { return static_cast<NppXmlDoc*>(_pXmlNativeLangDoc); }
    ...
    // Plugin directory
    QString getPluginRootDir() const { return QCoreApplication::applicationDirPath() + "/plugins"; }
