...
// Namespace-scope delegate to the class singleton.
// Uses noinline to prevent the compiler from generating a weak reference that
// shadows NppDarkMode::NppDarkMode::instance() and causes linker symbol collision.
[[gnu::noinline]] inline NppDarkMode& instance() { return NppDarkMode::instance(); }
