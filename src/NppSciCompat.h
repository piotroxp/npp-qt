...
namespace npp_sci {
    ...
    // ==== SC_MOD_* — Scintilla modification flags ====
    ...
    constexpr int SC_MOD_CHANGEMARKER        = 0x0010;
    constexpr int SC_MOD_CHANGEFOLD          = 0x0020;
    constexpr int SC_MOD_CHANGESTYLE         = 0x0040;
    constexpr int SC_MOD_BEFOREINSERT        = 0x0400;
    constexpr int SC_MOD_BEFOREDELETE        = 0x0800;
    constexpr int SC_MOD_CHANGEINDICATOR     = 0x4000;
    ...
    constexpr int SC_MOD_PERFORMED_UNDO      = 0x0200;
    constexpr int SC_MOD_PERFORMED_REDO      = 0x0400;
    constexpr int SC_MOD_MODEVENTMASKALL      = 0x3fffff;
    constexpr int SC_PERFORMED_UNDO          = SC_MOD_PERFORMED_UNDO;
    constexpr int SC_PERFORMED_REDO          = SC_MOD_PERFORMED_REDO;

    // ==== SCN_* — Scintilla notification codes (Scintilla.h) ====
    ...
    constexpr int SCN_EDITABLECHANGE    = 2040;
    constexpr int SCN_HIGHLIGHTGUIDE    = 2050;
...
// SC_UPDATE_*, SC_MOD_*, SCN_* constants
using npp_sci::SC_UPDATE_NONE;
using npp_sci::SC_UPDATE_CONTENT;
using npp_sci::SC_UPDATE_SELECTION;
using npp_sci::SC_UPDATE_V_SCROLL;
using npp_sci::SC_UPDATE_H_SCROLL;
using npp_sci::SC_MOD_NONE;
using npp_sci::SC_MOD_INSERTTEXT;
using npp_sci::SC_MOD_DELETETEXT;
using npp_sci::SC_MOD_CHANGEFIRST;
using npp_sci::SC_MOD_CHANGELAST;
using npp_sci::SC_MOD_CHANGEMARKER;
using npp_sci::SC_MOD_CHANGEFOLD;
using npp_sci::SC_MOD_CHANGESTYLE;
using npp_sci::SC_MOD_BEFOREINSERT;
using npp_sci::SC_MOD_BEFOREDELETE;
using npp_sci::SC_MOD_CHANGEINDICATOR;
using npp_sci::SC_MOD_CHANGELINESTATE;
using npp_sci::SC_MOD_CHANGEANNOTATION;
using npp_sci::SC_MOD_CONTAINER;
using npp_sci::SC_MOD_LEXERSTATE;
using npp_sci::SC_MOD_INSERTCHECK;
using npp_sci::SC_MOD_CHANGETABSTOPS;
using npp_sci::SC_MOD_CHANGEEOLANNOTATION;
using npp_sci::SC_MOD_PERFORMED_UNDO;
using npp_sci::SC_MOD_PERFORMED_REDO;
using npp_sci::SC_MOD_MODEVENTMASKALL;
using npp_sci::SC_PERFORMED_UNDO;
using npp_sci::SC_PERFORMED_REDO;
using npp_sci::SCN_STYLENEEDED;
using npp_sci::SCN_CHARADDED;
using npp_sci::SCN_SAVEPOINTREACHED;
using npp_sci::SCN_SAVEPOINTLEFT;
using npp_sci::SCN_MODIFYATTEMPTRO;
using npp_sci::SCN_KEY;
using npp_sci::SCN_DOUBLECLICK;
using npp_sci::SCN_UPDATEUI;
using npp_sci::SCN_MODIFIED;
using npp_sci::SCN_MACRORECORD;
using npp_sci::SCN_MARGINCLICK;
using npp_sci::SCN_NEEDSHOWN;
using npp_sci::SCN_PAINTED;
using npp_sci::SCN_USERLISTSELECTION;
using npp_sci::SCN_URIDROPPED;
using npp_sci::SCN_DWELLSTART;
using npp_sci::SCN_DWELLEND;
using npp_sci::SCN_ZOOM;
using npp_sci::SCN_HOTSPOTCLICK;
using npp_sci::SCN_HOTSPOTDOUBLECLICK;
using npp_sci::SCN_CALLTIPCLICK;
using npp_sci::SCN_AUTOCSELECTION;
using npp_sci::SCN_INDICATORCLICK;
using npp_sci::SCN_INDICATORRELEASE;
using npp_sci::SCN_AUTOCCANCELLED;
using npp_sci::SCN_AUTOCCHARDELETED;
using npp_sci::SCN_HOTSPOTRELEASECLICK;
using npp_sci::SCN_FOCUSIN;
using npp_sci::SCN_FOCUSOUT;
using npp_sci::SCN_AUTOCCOMPLETED;
using npp_sci::SCN_MARGINRIGHTCLICK;
using npp_sci::SCN_EDITABLECHANGE;
using npp_sci::SCN_HIGHLIGHTGUIDE;
