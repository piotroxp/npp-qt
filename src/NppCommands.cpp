...
#include "MISC/sha1/calc_sha1.h"
#include "MISC/sha512/sha512.h"
#include "MISC/Common/SortLocale.h"
		...
		case IDM_FILE_OPEN_FOLDER:
		{
			...
			if (hr == HRESULT_FROM_WIN32(ERROR_FILE_NOT_FOUND))
			{
				...
				::ShellExecuteW(_pPublicInterface->getHSelf(), L"explore",
					std::filesystem::path(_pEditView->getCurrentBuffer()->getFullPathName()).parent_path().wstring().c_str(), nullptr, nullptr, SW_SHOWNORMAL);
			}
