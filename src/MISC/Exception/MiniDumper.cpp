//Adapted from http://www.codeproject.com/KB/debug/postmortemdebug_standalone1.aspx
...
bool MiniDumper::writeDump(EXCEPTION_POINTERS * pExceptionInfo)
{
	...
	HMODULE hDll = ::LoadLibraryEx(L"DBGHELP.DLL", nullptr, LOAD_LIBRARY_SEARCH_SYSTEM32);
...
bool MiniDumper::writeDump([[maybe_unused]] void* pExceptionInfo)
{
	// MiniDumper is not available on non-Windows platforms
	return false;
}
