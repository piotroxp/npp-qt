...
NppNotification NppNotification::custom(const QString& eventType, const NppNotificationData& extraData) {
    ...
    n.data.metadata.unite(extraData.metadata);
    return n;
}
...
// =============================================================================
// NppSciNotificationBridge Implementation
// =============================================================================
...
bool NppSciNotificationBridge::handleScintillaNotification(const SCNotification* notification, int bufferId) {
...
bool NppSciNotificationBridge::handleNppNotification(void*, unsigned int code,
...
NppNotification NppSciNotificationBridge::toNotification(
    ...
    switch (sciNotification->nmhdr.code) {
        case SCN_SAVEPOINTLEFT:
            n = NppNotification(NppNotificationType::BufferDirty, NppNotificationPriority::Low);
            break;
        case SCN_SAVEPOINTREACHED:
            n = NppNotification(NppNotificationType::BufferClean, NppNotificationPriority::Low);
            break;
        case SCN_MODIFIED:
            n = NppNotification(NppNotificationType::BufferModified, NppNotificationPriority::Normal);
            break;
        case SCN_ZOOM:
            n = NppNotification(NppNotificationType::ZoomChanged, NppNotificationPriority::Low);
            n.data.set("zoom", 0); // actual zoom from scintilla
            break;
        case SCN_UPDATEUI:
            n = NppNotification(NppNotificationType::SelectionChanged, NppNotificationPriority::Low);
            break;
        default:
            break;
    }
...
bool NppSciNotificationBridge::handleModified(const SCNotification*, int bufferId) {
...
bool NppSciNotificationBridge::handleMarginClick(const SCNotification*, int) {
    return false;
}

bool NppSciNotificationBridge::handleCharAdded(const SCNotification*, int) {
    return false;
}

bool NppSciNotificationBridge::handleDoubleClick(const SCNotification*, int) {
    return false;
}

bool NppSciNotificationBridge::handleUpdateUI(const SCNotification*, int bufferId) {
    emit selectionChanged();
    return false;
}

bool NppSciNotificationBridge::handleZoom(const SCNotification*, int bufferId) {
    emit zoomChanged(0);
    return false;
}

bool NppSciNotificationBridge::handlePainted(const SCNotification*, int) {
    return false;
}

bool NppSciNotificationBridge::handleAutoComplete(const SCNotification*, int) {
    return false;
}
