...
// Minimal SCNotification struct — forward-declared in ScintillaEditBase.h
// Only fields we actually use are defined here.
...
struct SCNotification {
    ...
    // Only minimal fields needed — add as required
};
