...
static bool isInListA(const char* token, const char* list)
{
    if ((!token) || (!list))
        return false;
    ...
    size_t i = 0;
    size_t j = 0;
    for (size_t len = std::strlen(list); i <= len; ++i)
    {
        if ((list[i] == ' ') || (list[i] == '\0'))
        {
            if (j != 0)
...
int EncodingMapper::getIndexFromEncoding(int encoding) const
{
    ...
    if (encoding == -1)
        return -1;
    for (i = 0; static_cast<int>(i) < static_cast<int>(nbItem); ++i)
    {
...
QString EncodingMapper::codePageToCodecName(int codePage)
{
    switch (codePage)
    {
        case 1250: return QStringLiteral("Windows-1250");
        case 1251: return QStringLiteral("Windows-1251");
        case 1252: return QStringLiteral("Windows-1252");
        case 1253: return QStringLiteral("Windows-1253");
        case 1254: return QStringLiteral("Windows-1254");
        case 1255: return QStringLiteral("Windows-1255");
        case 1256: return QStringLiteral("Windows-1256");
        case 1257: return QStringLiteral("Windows-1257");
        case 1258: return QStringLiteral("Windows-1258");
        ...
        case 28604: return QStringLiteral("ISO-8859-14");
        case 28605: return QStringLiteral("ISO-8859-15");
        case 437:   return QStringLiteral("CP437");
        case 720:   return QStringLiteral("CP720");
        case 737:   return QStringLiteral("CP737");
        case 775:   return QStringLiteral("CP775");
        case 850:   return QStringLiteral("CP850");
        case 852:   return QStringLiteral("CP852");
        case 855:   return QStringLiteral("CP855");
        case 857:   return QStringLiteral("CP857");
        case 858:   return QStringLiteral("CP858");
        case 860:   return QStringLiteral("CP860");
        case 861:   return QStringLiteral("CP861");
        case 862:   return QStringLiteral("CP862");
        case 863:   return QStringLiteral("CP863");
        case 865:   return QStringLiteral("CP865");
        case 866:   return QStringLiteral("CP866");
        case 869:   return QStringLiteral("CP869");
        case 950:   return QStringLiteral("Big5");
        case 936:   return QStringLiteral("GBK");
        case 932:   return QStringLiteral("Shift-JIS");
        case 949:   return QStringLiteral("EUCKR");
        case 51949: return QStringLiteral("EUC-KR");
        case 874:   return QStringLiteral("TIS-620");
        case 10007: return QStringLiteral("x-mac-cyrillic");
        case 21866: return QStringLiteral("KOI8-U");
        case 20866: return QStringLiteral("KOI8-R");
