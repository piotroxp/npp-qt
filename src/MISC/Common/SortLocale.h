...
// Qt-compatible message box flags (Windows equivalents: MB_ICONWARNING=0x00000030L, MB_ICONERROR=0x00000010L)
...
public:
	struct Result
	{
		unsigned int status = 0;       // Will be 0 (successful sort), MB_ICONWARNING or MB_ICONERROR
