...
// =============================================================================
// NppData — Notepad++ handle bundle
// =============================================================================

// NppData holds the three main window handles that plugins use to communicate
// with Notepad++.  In the Win32 original these are HWND values passed from
// the host to each plugin via setInfo().
//
// Qt6 mapping:
//   - _nppHandle          → QWidget* of the main Notepad++ window
//   - _scintillaMainHandle→ QWidget* of the primary Scintilla editor
//   - _scintillaSecondHandle → QWidget* of the secondary Scintilla editor (split view)
struct NppData
{
    // Main Notepad++ window handle
    QWidget* _nppHandle = nullptr;

    // Primary (first) Scintilla editor window
    QWidget* _scintillaMainHandle = nullptr;

    // Secondary (second) Scintilla editor window (split pane)
