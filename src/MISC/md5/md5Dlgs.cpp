    ...
    : QDialog(parent)
{
    ...
    hashCombo->addItem("MD5", HashType::hash_md5);
    hashCombo->addItem("SHA-1", HashType::hash_sha1);
    hashCombo->addItem("SHA-256", HashType::hash_sha256);
    hashCombo->addItem("SHA-512", HashType::hash_sha512);
    ...
    connect(hashCombo, QOverload<int>::of(&QComboBox::currentIndexChanged), this, [this, hashCombo](int idx) {
        ...
        for (const QString& file : fileList) {
            ...
            if (f.open(QIODevice::ReadOnly)) {
                QCryptographicHash::Algorithm algo =
                    _ht == HashType::hash_md5 ? QCryptographicHash::Md5 :
                    _ht == HashType::hash_sha1 ? QCryptographicHash::Sha1 :
                    _ht == HashType::hash_sha256 ? QCryptographicHash::Sha256
