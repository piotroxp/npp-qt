...
// Semantic Lift: Win32 .rc.h resource IDs → Qt6 programmatic IDs
// These integer constants are dialog/layout IDs used by FindReplace dialogs.
// Qt6 uses objectName() + qobject_cast / findChild rather than numeric IDs
// for Qt widgets, but the numeric values are retained for compatibility with
// the existing FindReplaceDlg implementation that was written against these IDs.
#pragma once
...
// ============================================================================
// Find/Replace Command Panel (in Find Result view)
// ============================================================================
