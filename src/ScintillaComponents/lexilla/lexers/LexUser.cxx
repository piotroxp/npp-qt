...
static void ColouriseUserDoc(Sci_PositionU startPos, Sci_Position length, int initStyle, WordList *kwLists[], Accessor &styler)
{
    ...
    snprintf((nestingBuffer+20), sizeof((nestingBuffer+20)), "%d", SCE_USER_STYLE_COMMENT);    int commentNesting      = styler.GetPropertyInt(nestingBuffer, 0);
    snprintf((nestingBuffer+20), sizeof((nestingBuffer+20)), "%d", SCE_USER_STYLE_COMMENTLINE);    int lineCommentNesting  = styler.GetPropertyInt(nestingBuffer, 0);
    snprintf((nestingBuffer+19), sizeof((nestingBuffer+19)), "%d", SCE_USER_STYLE_DELIMITER1);    int delim1Nesting       = styler.GetPropertyInt(nestingBuffer, 0);  // one byte difference
    snprintf((nestingBuffer+19), sizeof((nestingBuffer+19)), "%d", SCE_USER_STYLE_DELIMITER2);    int delim2Nesting       = styler.GetPropertyInt(nestingBuffer, 0);  // for two-digit numbers
    snprintf((nestingBuffer+19), sizeof((nestingBuffer+19)), "%d", SCE_USER_STYLE_DELIMITER3);    int delim3Nesting       = styler.GetPropertyInt(nestingBuffer, 0);
    snprintf((nestingBuffer+19), sizeof((nestingBuffer+19)), "%d", SCE_USER_STYLE_DELIMITER4);    int delim4Nesting       = styler.GetPropertyInt(nestingBuffer, 0);
    snprintf((nestingBuffer+19), sizeof((nestingBuffer+19)), "%d", SCE_USER_STYLE_DELIMITER5);    int delim5Nesting       = styler.GetPropertyInt(nestingBuffer, 0);
    snprintf((nestingBuffer+19), sizeof((nestingBuffer+19)), "%d", SCE_USER_STYLE_DELIMITER6);    int delim6Nesting       = styler.GetPropertyInt(nestingBuffer, 0);
    snprintf((nestingBuffer+19), sizeof((nestingBuffer+19)), "%d", SCE_USER_STYLE_DELIMITER7);    int delim7Nesting       = styler.GetPropertyInt(nestingBuffer, 0);
    snprintf((nestingBuffer+19), sizeof((nestingBuffer+19)), "%d", SCE_USER_STYLE_DELIMITER8);    int delim8Nesting       = styler.GetPropertyInt(nestingBuffer, 0);
