...
#define TCN_TABDROPPED (0xFFFFFDDAu - 10u)
#define TCN_TABDROPPEDOUTSIDE (0xFFFFFDDAu - 11u)
#define TCN_TABDELETE (0xFFFFFDDAu - 12u)
#define TCN_MOUSEHOVERING (0xFFFFFDDAu - 13u)
#define TCN_MOUSELEAVING (0xFFFFFDDAu - 14u)
#define TCN_MOUSEHOVERSWITCHING (0xFFFFFDDAu - 15u)
#define TCN_TABPINNED (0xFFFFFDDAu - 16u)
