...
Q_CONSTINIT static const qt_meta_stringdata_PreferenceDialog_t qt_meta_stringdata_PreferenceDialog = {
    {
        ...
        QT_MOC_LITERAL(32, 13),  // "applySettings"
        QT_MOC_LITERAL(46, 17),  // "onCategoryChanged"
        QT_MOC_LITERAL(64, 16),  // "QTreeWidgetItem*"
        QT_MOC_LITERAL(81, 4),  // "item"
        QT_MOC_LITERAL(86, 6)   // "column"
    },
    "PreferenceDialog",
    "accept",
    "",
...
void PreferenceDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->onCategoryChanged((*reinterpret_cast< std::add_pointer_t<QTreeWidgetItem*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        default: ;
        }
    }
}
