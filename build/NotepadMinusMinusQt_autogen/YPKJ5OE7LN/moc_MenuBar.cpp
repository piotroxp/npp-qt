...
Q_CONSTINIT static const qt_meta_stringdata_MenuBar_t qt_meta_stringdata_MenuBar = {
    {
        ...
        QT_MOC_LITERAL(8, 11),  // "menuCommand"
        QT_MOC_LITERAL(20, 0),  // ""
        QT_MOC_LITERAL(21, 3)   // "cmd"
    },
    "MenuBar",
    "menuCommand",
    "",
...
void MenuBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->menuCommand((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MenuBar::*)(const QString & );
            if (_t _q_method = &MenuBar::menuCommand; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MenuBar::menuCommand(const QString & _t1)
{
