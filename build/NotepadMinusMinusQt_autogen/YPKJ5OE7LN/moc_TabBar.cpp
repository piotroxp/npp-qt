...
Q_CONSTINIT static const qt_meta_stringdata_TabBar_t qt_meta_stringdata_TabBar = {
    {
        ...
        QT_MOC_LITERAL(7, 14),  // "tabMovedSignal"
        QT_MOC_LITERAL(22, 0),  // ""
        QT_MOC_LITERAL(23, 4),  // "from"
        QT_MOC_LITERAL(28, 2)   // "to"
    },
    "TabBar",
    "tabMovedSignal",
    "",
...
void TabBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->tabMovedSignal((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &TabBar::tabMovedSignal; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TabBar::tabMovedSignal(int _t1, int _t2)
{
