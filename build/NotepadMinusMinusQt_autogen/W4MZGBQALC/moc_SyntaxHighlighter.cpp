...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_SyntaxHighlighter_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_SyntaxHighlighter_t qt_meta_stringdata_SyntaxHighlighter = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_SyntaxHighlighter[] = {
...
Q_CONSTINIT const QMetaObject SyntaxHighlighter::staticMetaObject = { {
    ...
    qt_meta_stringdata_SyntaxHighlighter.offsetsAndSizes,
    qt_meta_data_SyntaxHighlighter,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_SyntaxHighlighter_t,
        // Q_OBJECT / Q_GADGET
