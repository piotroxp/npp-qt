...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Printer_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Printer_t qt_meta_stringdata_Printer = {
    {
        QT_MOC_LITERAL(0, 7)   // "Printer"
    },
    "Printer"
};
...
Q_CONSTINIT static const uint qt_meta_data_Printer[] = {
...
Q_CONSTINIT const QMetaObject Printer::staticMetaObject = { {
    ...
    qt_meta_stringdata_Printer.offsetsAndSizes,
    qt_meta_data_Printer,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Printer_t,
        // Q_OBJECT / Q_GADGET
