...
#include <memory>
#include "../../../src/WinControls/AnsiCharPanel.h"
...
namespace {
struct qt_meta_stringdata_AnsiCharPanel_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_AnsiCharPanel_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_AnsiCharPanel_t qt_meta_stringdata_AnsiCharPanel = {
    {
        QT_MOC_LITERAL(0, 13),  // "AnsiCharPanel"
        QT_MOC_LITERAL(14, 19),  // "charInsertRequested"
        QT_MOC_LITERAL(34, 0),  // ""
        QT_MOC_LITERAL(35, 5),  // "bytes"
        QT_MOC_LITERAL(41, 12),  // "rowActivated"
        QT_MOC_LITERAL(54, 8),  // "rowIndex"
        QT_MOC_LITERAL(63, 19),  // "onItemDoubleClicked"
        QT_MOC_LITERAL(83, 3),  // "row"
        QT_MOC_LITERAL(87, 3),  // "col"
        QT_MOC_LITERAL(91, 15)   // "onItemActivated"
    },
    "AnsiCharPanel",
    "charInsertRequested",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_AnsiCharPanel[] = {
...
Q_CONSTINIT const QMetaObject AnsiCharPanel::staticMetaObject = { {
    ...
    qt_meta_stringdata_AnsiCharPanel.offsetsAndSizes,
    qt_meta_data_AnsiCharPanel,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_AnsiCharPanel_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<AnsiCharPanel, std::true_type>,
        // method 'charInsertRequested'
...
void AnsiCharPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (AnsiCharPanel::*)(const QByteArray & );
            if (_t _q_method = &AnsiCharPanel::charInsertRequested; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (AnsiCharPanel::*)(int );
            if (_t _q_method = &AnsiCharPanel::rowActivated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *AnsiCharPanel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AnsiCharPanel.stringdata0))
